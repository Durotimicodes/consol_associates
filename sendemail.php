...
define( "RECIPIENT_NAME", "Consol Associates" );
define( "RECIPIENT_EMAIL", "info@consolassociates.com" );
...
if ( $Sendername && $senderEmail && $senderPhone && $senderSubject && $message) {
  ...
  $msgBody = " Username: " . $Sendername . " Email: " . $senderEmail . " Phone: " . $senderPhone . " Subject: " . $senderSubject . " Message: " . $message . "";
